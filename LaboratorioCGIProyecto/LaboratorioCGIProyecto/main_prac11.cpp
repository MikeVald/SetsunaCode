...
void display(Shader shader, Model botaDer, Model piernaDer, Model piernaIzq, Model torso,
	Model brazoDer, Model brazoIzq, Model cabeza, Model piso, Model muro1)
{
	shader.use();
	...
	shader.setVec3("pointLight.position", glm::vec3(movLuzX, 4.0f, 3.0f));
	...
	model = glm::translate(glm::mat4(1.0f), glm::vec3(10.0f, 3.0f, 1.0f));
	model = glm::scale(model, glm::vec3(0.07f, 0.07f, 0.07f));
	shader.setMat4("model", model);
	muro1.Draw(shader);
	/*
...
int main()
{
	...
	//Model botaDer = ((char *)"Models/carrito/carrito.obj");
	...
	Model pisoModel = ((char *)"Models/Suelo/suelo.obj");
	Model muro1 = ((char *)"Models/Ventana/Muro1.obj");
